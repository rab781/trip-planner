...
The application exposes several RESTful endpoints for managing itineraries, destinations, cities, and zones. Public endpoints do not require authentication, while protected endpoints require a Sanctum Bearer token.

See the [full OpenAPI reference in openapi.yml](openapi.yml) for complete details on paths, parameters, schemas, and responses.
