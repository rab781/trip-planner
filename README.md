...
See the [full OpenAPI reference in openapi.yml](openapi.yml) for complete details on available endpoints, parameters, schemas, rate limits, and authentication.
