...
## 2024-05-24 - [Medium] Sensitive Data Exposure in API Errors
**Vulnerability:** Raw exception messages were returned in JSON API responses.
**Learning:** Returning $e->getMessage() directly to users can expose sensitive system details.
**Prevention:** Always log exceptions and return generic error messages.
