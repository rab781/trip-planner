    ...
    return (
        <>
            ...
            <button
                ...
                className={`fixed bottom-6 right-6 z-50 p-4 rounded-full shadow-2xl transition-all duration-300 transform hover:scale-110 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-button ${
                    isOpen
                        ...
                        <div className="flex flex-wrap gap-2">
                            {quickQuestions.map((question, index) => (
                                <button
                                    ...
                                    className="text-xs px-3 py-1.5 bg-background text-button rounded-full hover:bg-gradient-to-r hover:from-button hover:to-highlight hover:text-white transition-all focus:outline-none focus:ring-2 focus:ring-button focus:ring-offset-1"
                                >
                                    {question}
                                </button>
                            ))}
