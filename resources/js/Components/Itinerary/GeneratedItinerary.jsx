...
function DaySection({
    ...
    return (
        <div className="glass-card rounded-2xl overflow-hidden border border-white/20 shadow-sm hover:shadow-md transition-all">
            ...
            {/* Day Content */}
            <div id={dayContentId} className={`transition-all duration-300 ease-in-out border-t border-gray-100 dark:border-gray-700/50 ${isExpanded ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-4 hidden'
                }`}>
