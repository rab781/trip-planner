...
export default function Create({ zones, categories }) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        category_id: '',
        thumbnail: null,
        ticket_variants: [{ name: 'Tiket Masuk', price: '', description: '' }],
    });
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="md:col-span-2">
                                ...
                                <textarea
                                    ...
                                    placeholder="Deskripsi singkat tentang destinasi ini..."
                                />
                            </div>
