...
class ItineraryController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        // ⚡ Bolt: Cache static destination and ticket variant datasets to prevent heavy DB querying and JSON serialization overhead on every page load
        $destinations = Cache::remember('destinations_with_variants', now()->addMinutes(15), function () {
