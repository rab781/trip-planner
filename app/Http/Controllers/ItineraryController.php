...
class ItineraryController extends Controller
{
    ...
    {
        // ⚡ Bolt: Cache heavy reference datasets and transformations to prevent redundant queries and map loop overhead
        [$cities, $zones, $categories, $destinations] = \Illuminate\Support\Facades\Cache::remember('itinerary_form_datasets', 900, function () {
            return [
                City::all(),
                Zone::with('city')->get(),
                Category::all(),
