...
class ItineraryController extends Controller
{
    ...
    {
        $cities = Cache::remember('itinerary_create_cities', 900, function () {
            return City::all();
        });

        $zones = Cache::remember('itinerary_create_zones', 900, function () {
            return Zone::with('city')->get();
        });

        $categories = Cache::remember('itinerary_create_categories', 900, function () {
            return Category::all();
        });

        $destinations = Cache::remember('itinerary_create_destinations', 900, function () {
