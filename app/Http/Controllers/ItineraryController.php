...
class ItineraryController extends Controller
{
    ...
    {
        // ⚡ Bolt: Cache static reference datasets to prevent heavy querying and serialization overhead on every page load
        [$cities, $zones, $categories, $destinations] = Cache::remember('itinerary_form_reference_data', 900, function () {
            return [
                City::all(),
                Zone::with('city')->get(),
                Category::all(),
