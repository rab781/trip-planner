...
class ItineraryController extends Controller
{
    ...
    {
        // ⚡ Bolt: Cache large reference datasets to avoid repeated DB queries and serialization overhead
        $referenceData = Cache::remember('itinerary_form_reference_data', 900, function () {
            return [
                'cities' => City::all(),
