...
class ItineraryController extends Controller
{
    ...
    {
        // ⚡ Bolt: Cache reference data (cities, zones, categories, destinations) to avoid expensive querying and serialization on every page load
        [$cities, $zones, $categories, $destinations] = Cache::remember('itinerary_reference_data', 900, function () {
            return [
                City::all(),
                Zone::with('city')->get(),
                Category::all(),
