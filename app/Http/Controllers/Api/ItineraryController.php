...
class ItineraryController extends Controller
{
    ...
    public function store(Request $request, ItineraryService $itineraryService)
    {
        ...
        try {
            ...
            \Illuminate\Support\Facades\Log::error('Itinerary creation failed: ' . $e->getMessage());
            return response()->json([
                'success' => false,
                'data' => null,
    ...
    public function syncItems(Request $request, $id, ItineraryService $itineraryService)
    {
        ...
        try {
            ...
            \Illuminate\Support\Facades\Log::error('Failed to sync items: ' . $e->getMessage());
            return response()->json([
                'success' => false,
    ...
    public function generate(Request $request, ItineraryGeneratorService $generatorService)
    {
        ...
        try {
            ...
            \Illuminate\Support\Facades\Log::error('Failed to generate itinerary: ' . $e->getMessage());
            return response()->json([
                'success' => false,
    ...
    public function regenerateDay(Request $request, ItineraryGeneratorService $generatorService)
    {
        ...
        try {
            ...
            \Illuminate\Support\Facades\Log::error('Failed to regenerate day: ' . $e->getMessage());
            return response()->json([
                'success' => false,
    ...
    public function suggestReplacement(Request $request, ItineraryGeneratorService $generatorService)
    {
        ...
        try {
            ...
            \Illuminate\Support\Facades\Log::error('Failed to get suggestions: ' . $e->getMessage());
            return response()->json([
                'success' => false,
