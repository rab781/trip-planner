...
class ItineraryController extends Controller
{
    ...
    public function store(Request $request, ItineraryService $itineraryService)
    {
        ...
        try {
            ...
            Log::error('Itinerary creation failed: ' . $e->getMessage(), ['exception' => $e]);
            return response()->json([
                'success' => false,
                'data' => null,
                'message' => 'Itinerary creation failed due to a server error.',
                'status' => 500,
            ], 500);
        }
    }
    ...
    public function syncItems(Request $request, $id, ItineraryService $itineraryService)
    {
        ...
        try {
            ...
            Log::error('Failed to sync items: ' . $e->getMessage(), ['exception' => $e]);
            return response()->json([
                'success' => false,
                'message' => 'Failed to sync items due to a server error.',
            ], 500);
        }
    }
    ...
    public function generate(Request $request, ItineraryGeneratorService $generatorService)
    {
        ...
        try {
            ...
            Log::error('Failed to generate itinerary: ' . $e->getMessage(), ['exception' => $e]);
            return response()->json([
                'success' => false,
                'message' => 'Failed to generate itinerary due to a server error.',
            ], 500);
        }
    }
    ...
    public function regenerateDay(Request $request, ItineraryGeneratorService $generatorService)
    {
        ...
        try {
            ...
            Log::error('Failed to regenerate day: ' . $e->getMessage(), ['exception' => $e]);
            return response()->json([
                'success' => false,
                'message' => 'Failed to regenerate day due to a server error.',
            ], 500);
        }
    }
    ...
    public function suggestReplacement(Request $request, ItineraryGeneratorService $generatorService)
    {
        ...
        try {
            ...
            Log::error('Failed to get suggestions: ' . $e->getMessage(), ['exception' => $e]);
            return response()->json([
                'success' => false,
                'message' => 'Failed to get suggestions due to a server error.',
            ], 500);
        }
    }
}
